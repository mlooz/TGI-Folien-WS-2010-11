...
\KITfoot{Tutoriumsmaterial von Simon Stroh und Moritz v. Looz}%TODO
...
\begin{frame}
 \frametitle{Wiederholung der Wiederholung: Reguläre Sprachen}
        Eine Sprache \(L\subseteq\Sigma^*\) heisst regulär, wenn für sie eine der folgenden Punkte gilt:
...
\begin{frame}
 ...
 \begin{center}
   \vspace{-6ex}
   %\includegraphics[scale=.8]{pics/NEA_01} TODO add picture
 \end{center}
\end{frame}
\begin{frame}
...
\begin{frame}
	...
	\KITframe[or maybe use grey instead?] 
	{\parbox{\textwidth}{
	    \(q_n \in Q\), \(a \in \Sigma\)
	}}\\[0.2cm]	
	%Solange 
