...
\end{frame}
%TODO: if time, graphisomorph example plus krypto example
...
\begin{block}{Definition}
Ein Algorithmus wird pseudopolynimiell genannt, wenn seine Laufzeit in Polynom im numerischen Wert der Eingabe (und eben nicht der Länge der Eingabe) ist.
\end{block}
Ein Problem heißt schwach $\matcal{NP}$-Vollständig, wenn es $\mathcal{NP}$-Vollständig ist und ein pseudopolynimieller Algorithmus der das Problem entscheidet existiert.\\
