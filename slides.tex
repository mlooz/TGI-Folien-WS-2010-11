...
\begin{exampleblock}{Definition}
        ...
        \[ (\mathcal{\sum}, \mathcal{V}, S, \mathcal{R}).  \]
            
        \begin{itemize}
        \item $\mathcal{\sum}$:  endliches Terminalalphabet  
        \item $\mathcal{V}$:  endliches Nichtterminal/Variablenalphabet  
        \item $S$:    Startsymbol  
        \item $\mathcal{R}$:  endlich viele Produktionen
        \end{itemize}
\end{exampleblock}
Wir schreiben $L(G)$ für die Sprache die von der Grammatik $G$ erzeugt wird.
}
...
Grundidee:
\begin{itemize}
\item Überprüfe für jedes Teilwort in aufsteigenden Länge aus welchen nichtterminalen es erzeugt werden kann.
\item $\rightarrow$ Tafel
\end{itemize}
}
