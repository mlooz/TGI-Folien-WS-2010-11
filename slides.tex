...
\begin{block}{Definition (ii)}
 ...
 Dann können die Regeln $A \rightarrow A\alpha_1$, ..., $A \rightarrow A\alpha_r$ durch die Regeln $A \rightarrow \beta_1B$,...,
 $A \rightarrow \beta_sB$,$B \rightarrow \alpha_1$,..., $B \rightarrow \alpha_r$,$B \rightarrow \alpha_1 B$, ---, $B \rightarrow \alpha_r B$
...
\begin{frame}
 \frametitle{Beispielumwandlung}
Zunächst müssen wir $V$ sortieren.
\begin{align*}
A_1 &\rightarrow A_3A_1 \mid 0\\
A_3 &\rightarrow \textcolor{red}{A_2A_1} \\
A_2 &\rightarrow 1 \\
\end{align*}
\begin{align*}
A_1 &\rightarrow A_2A_1 \mid 0\\
