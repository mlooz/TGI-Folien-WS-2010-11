...
Die Chomsky-Hierarchie ist eine Unterteilung von Grammatiken und den davon erzeugten Sprachen.
\begin{block}{Definition}
...
Um CYK anzuwenden, muss die gegebene Grammatik erst in Chomsky-Normalform gebracht werden.
\
...
\begin{itemize}
\item $\mathcal{S} \rightarrow \lambda$
\item  $A \rightarrow BC$
\item  $A \rightarrow a$
\end{itemize}
Wobei gilt $\mathcal{S}$ ist Startsymbol $\in \mathcal{V}$, $A,B,C\in\mathcal{V}$ und $a \in \mathcal{T}$.
Falls $\mathcal{S} \rightarrow \lambda$ dazugehört, darf $\mathcal{S}$ nicht auf der rechten Seite einer Produktion vorkommen.
\end{exampleblock}
\emph{Bemerkung}: Da $\mathcal{S} \in \mathcal{V}$, ist somit natürlich auch $\mathcal{S} \rightarrow BC \mid a$ möglich.
}
...
\begin{exampleblock}{Umwandlungsbeispiel (Schritt 1 von 3)}
\begin{columns}[c]
\begin{column}{0.3\textwidth}
\begin{align*}
\mathcal{S} &\rightarrow XY\\
X &\rightarrow \textcolor{red}{a}X\textcolor{red}{b} \mid \lambda\\
...
\begin{align*}
\mathcal{S} &\rightarrow XY\\
X &\rightarrow \textcolor{blue}{A}X\textcolor{blue}{B} \mid \lambda\\
...
\begin{enumerate}
\setcounter{enumi}{1}
\item %Die Grammatik $\lambda$-frei machen, d. h. $\lambda$ darf nur bei $\mathcal{S} \rightarrow \lambda$ vorkommen.
In diesem Schritt werden alle Produktionen der Form $\textcolor{red}{V} \rightarrow \textcolor{red}{\lambda}$
...
\begin{exampleblock}{Umwandlungsbeispiel (Schritt 2 von 3)}
\begin{columns}[c]
\begin{column}{0.3\textwidth}
\begin{align*}
\mathcal{S} &\rightarrow XY\\
\textcolor{red}{X} &\rightarrow AXB \mid \textcolor{red}{\lambda}\\
\textcolor{red}{Y} &\rightarrow CCY \mid \textcolor{red}{\lambda}\\
A &\rightarrow a\\
B &\rightarrow b\\
C &\rightarrow c\\
\end{align*}
...
\begin{column}{0.3\textwidth}
\begin{align*}
\textcolor{blue}{\mathcal{S}} &\rightarrow XY \mid \textcolor{blue}{X} \mid  \textcolor{blue}{Y} \mid \textcolor{blue}{\lambda}\\
\textcolor{blue}{X} &\rightarrow AXB \mid \textcolor{blue}{AB} \\
...
\begin{enumerate}
\setcounter{enumi}{2}
\item Für rechte Seiten mit nur \textcolor{red}{einer
einzigen oder mehr als zwei Variablen} gilt:
Bei einzelnen Variablen werden diese Produktionen wieder durch ihre ``Vorwegnahme'' mit
den anderen Produktionen ``verschmolzen''. Für Produktionen mit mehr als zwei
...
\begin{exampleblock}{Umwandlungsbeispiel (Schritt 3 von 3)}
\begin{columns}[c]
\begin{column}{0.3\textwidth}
\begin{align*}
\mathcal{S} &\rightarrow XY \mid \textcolor{red}{X} \mid  \textcolor{red}{Y} \mid \lambda\\
X &\rightarrow \textcolor{red}{AXB} \mid AB \\
...
\begin{column}{0.3\textwidth}
\begin{align*}
\mathcal{S} &\rightarrow XY \mid \textcolor{blue}{FB} \mid \textcolor{blue}{AB} \mid  \textcolor{blue}{GY}\mid \textcolor{blue}{CC} \mid \lambda\\
X &\rightarrow \textcolor{blue}{FB} \mid AB \\
...
\cyksymbol{\breite}{1}{a}
\cyksymbol{\breite}{2}{b}
\cyksymbol{\breite}{3}{c}
\cyksymbol{\breite}{4}{c}
\cyksymbol{\breite}{5}{c}
\cyksymbol{\breite}{6}{c}

\cykfield{\breite}{1}{1}{A}
\cykfield{\breite}{2}{1}{B}
\cykfield{\breite}{3}{1}{C}
\cykfield{\breite}{4}{1}{C}
\cykfield{\breite}{5}{1}{C}
\cykfield{\breite}{6}{1}{C}

\cykfield{\breite}{1}{2}{\mathcal{S},X}
\cykfield{\breite}{2}{2}{}
\cykfield{\breite}{3}{2}{\mathcal{S},Y,G}
\cykfield{\breite}{4}{2}{\mathcal{S},Y,G}
\cykfield{\breite}{5}{2}{\mathcal{S},Y,G}
...
\cykfield{\breite}{1}{4}{\mathcal{S}}
\cykfield{\breite}{2}{4}{}
\cykfield{\breite}{3}{4}{\mathcal{S},Y}

\cykfield{\breite}{1}{5}{}
\cykfield{\breite}{2}{5}{}

\cykfield{\breite}{1}{6}{\mathcal{S}}
\end{tikzpicture}
\end{center}

In der Spitze steht das Startsymbol $\mathcal{S}$, also kann man das Wort mit den gegebenen Produktionen ableiten.
Es ist somit in der Sprache enthalten.
}
...
\begin{frame}
Modifiziere den CYK-Algorithmus so, dass er nicht einfach nur feststellt, ob eine Eingabe in der Sprache enthalten ist, sondern zusätzlich einen Syntaxbaum ermittelt.
\end{frame}

\section{11. Tutoriumsvorschlag}
\begin{frame}
 \frametitle{Pumping Lemma für kontextfreie Sprachen}
 Das Pumping Lemma, bekannt von den regulären Sprachen, kann für die kontextfreien Sprachen angepasst werden.
