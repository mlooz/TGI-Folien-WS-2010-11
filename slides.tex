...
\begin{frame}
\frametitle{Beispiel}
Die folgende Sprache ist in $\mathcal{P}$: Die gerichteter Graphen zusammen mit einem Start- und einem Endknoten, so dass der Endknoten vom Startknoten aus über die Kanten erreichbar ist.\\
