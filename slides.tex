...
\end{block}
\begin{block}{Polynomieller Ansatz - nicht immer optimal}
 Sortiere die Elemente in $M$ nach ihre 
\end{block}
...
\end{document}
TODO:
 - Instanzen für alte Probleme?
 - Probleme Vorstellen: EXACT COVER, SUBSET SUM, PARTITION (haben wir schon) :/
 - Noch nicht: Knapsack
