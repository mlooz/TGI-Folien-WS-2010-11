...
Es gibt weitere äquivalente Definitionen von NDTMs.
Man kann auch analog zu nichtdeterministischen endlichen Automaten NDTM als normale Turingmaschinen mit nicht eindeutiger Übergangsfunktion definieren.\\
\end{frame}
% NP als Klasse
\begin{frame}
