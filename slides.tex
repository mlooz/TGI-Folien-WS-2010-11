...
\end{center}
\end{figure}
Kann dieser Automat auf einen anderen Automaten zurückgeführt werden, der die gleiche Sprache akzeptiert aber weniger Zustände hat?
\pause
%Definition ``überflüssig''
%gerichteter Graph, Tiefensuche?
\\
...
%Äquivalenzklassenautomat und Minimierung von Automaten.
%Nichtoptimaler Beispielautomat (Kette von $b$s), nicht erreichbare Zustände
%Tiefensuche
%Äquivalenzklassenautomat
%Erinnerung: Eine Äquivalenzrelation heißt wohldefiniert, wenn es für die Relation unwichtig ist, welche Vertreter der Äquivalenzklasse gewählt werden.
%Konstruktion des Äquivalenzklassenautomaten
%(Nerode-Relation?)
