...
\begin{frame}
 ...
 \begin{enumerate}
  ...
  \item Eine Sprache $L \subseteq \Sigma^*$ heißt rekursiv oder entscheidbar, wenn es eine Turingmaschine gibt, die auf allen Eingaben stoppt und
...
%TODO Universelle Turingmaschinen
...
\item Alle Turingmaschinen die genau eine $0$ aufs Band Schreiben.
...
Eine nicht-leere Folge $I = i_1, i_2, \ldots, i_n$ von indices $\{1, \ldots, m\}$ heißt Lösung zu $P$, wenn $x_{i_1}x_{i_2}\ldots{}x_{i_n} = y_{i_1}y_{i_2}\ldots{}y_{i_n}$.
\end{frame}
